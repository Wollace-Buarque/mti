...
async function createActivity(request: express.Request, response: express.Response): Promise<any> {
...
async function deleteActivity(request: express.Request, response: express.Response): Promise<any> {
