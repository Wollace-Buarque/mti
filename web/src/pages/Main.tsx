      ...
      <div className="flex h-full w-full flex-col-reverse gap-7 px-4 sm:flex-row sm:px-0">
        <div className="flex flex-col items-center justify-center text-center sm:items-start sm:text-justify">
          ...
          <p className="mb-6">
            ...
            trata-se disso, um jeito de melhorar a qualidade de vida dos idosos
            por meio da tecnologia.
          </p>

          <p>
            Buscamos várias formas de melhorar a qualidade de vida dos idosos,
            como, por exemplo, criar uma rotina saudável, armazenando possíveis
            problemas em um banco de dados, para que sejam enviados para
            hospitais e formalizar um jeito em ques os resposáveis pelos idosos
            consigam ter um controle maior sobre os possíveis problemas.
          </p>
